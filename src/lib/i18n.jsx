...
const translations = {
  es: {
    ...
    footer: {
      ...
      desc: "No hacemos páginas web estáticas. Construimos ecosistemas digitales que hacen crecer tu negocio.",
  ...
  en: {
    ...
    hero: {
      ...
      clients: "Clients",
      badgeTitle: "Online Businesses",
      badgeSubtitle: "100% Operational",
    },
    ai: {
