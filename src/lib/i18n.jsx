...
const translations = {
  es: {
    ...
    hero: {
      tagline1: "Tu reputación ya existe.",
      tagline2: "Crecimiento medible.",
      cardHeading: "Sistemas Locales.",
      cardDesc: <><span className="text-white font-semibold">Texh Co</span> construye sistemas digitales de captación, visibilidad y automatización para negocios que quieren crecer.</>,
      clients: "Sistemas",
      badgeTitle: "Ecosistemas Activos",
      badgeSubtitle: "Generando Crecimiento",
    },
    ai: {
    ...
    about: {
      ...
      seDesc: "Arquitectura técnica y desarrollo de ecosistemas escalables. Transformo los problemas de tu negocio en código eficiente, automatizando procesos para que puedas escalar sin fricción.",
  ...
  en: {
    ...
    hero: {
      tagline1: "Your reputation exists.",
      tagline2: "Measurable growth.",
      cardHeading: "Local Systems.",
      cardDesc: <><span className="text-white font-semibold">Texh Co</span> builds digital systems for lead generation, visibility, and automation for growing businesses.</>,
      clients: "Systems",
      badgeTitle: "Active Ecosystems",
      badgeSubtitle: "Generating Growth",
    },
    ai: {
    ...
    about: {
      ...
      seTitle: "Lead Software Engineer",
      seDesc: "Technical architecture and scalable ecosystem development. I transform your business challenges into efficient code, automating processes so you can scale frictionlessly.",
